...
namespace Sample.ViewModels
{
    public class SampleKeyboardViewModel : OnScreenKeyboardViewModel
    {
        public SampleKeyboardViewModel()
        {
            ...
            mainSection.Rows[0].Keys.Add(new VirtualKey(VirtualKeyCode.ESCAPE));
            ...
            mainSection.Rows[0].Keys.Add(new ShiftSensitiveKey(VirtualKeyCode.OEM_3, "=", "+"));
            mainSection.Rows[0].Keys.Add(new VirtualKey(VirtualKeyCode.BACK){ButtonWidth = new GridLength(2, GridUnitType.Star)});
